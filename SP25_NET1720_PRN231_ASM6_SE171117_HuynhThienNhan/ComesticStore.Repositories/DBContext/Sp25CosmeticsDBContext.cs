...
namespace ComesticStore.Repositories.DBContext;
...
public partial class Sp25CosmeticsDBContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Cosmetic__19093A2B391FC545");
        });

        modelBuilder.Entity<CosmeticInformation>(entity =>
        {
            entity.HasKey(e => e.CosmeticId).HasName("PK__Cosmetic__98ED527E630237CF");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__SystemAc__349DA586C06ECD3C");
